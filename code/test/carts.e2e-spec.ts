...
describe('PATCH /carts/items/:id - validation tests', () => {
    ...
    describe('validation tests', () => {
        it(`returns 400 and product_id.cannotBeForeignKey`, async () => {
            ...
            expect(response.body.errorCodes).toContain('product_id.cannotBeForeignKey');
        });
        ...
        it(`returns 400 quantity.notDefined`, async () => {
            ...
            expect(response.body.errorCodes)
                .not.toContain('product_id.cannotBeForeignKey');
            expect(response.body.errorCodes)
                .not.toContain('product_id.notDefined');
        });
